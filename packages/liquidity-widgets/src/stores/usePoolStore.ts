...
import { ChainId, PoolType as Dex, Pool, Token, tick, token } from "../schema";
import { z } from "zod";
...
const dexMapping: Record<Dex, string> = {
  ...
  [Dex.DEX_LINEHUBV3]: "pancake-v3",
  [Dex.DEX_METAVAULTV3]: "pancake-v3",
  [Dex.DEX_SWAPMODEV3]: "pancake-v3",
